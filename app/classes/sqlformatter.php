...
class SqlFormatter
{
    ...
    public static $quote_attributes = 'class="quote"';
    public static $backtick_quote_attributes = 'class="backtick-quote"';
    public static $reserved_attributes = 'class="reserved"';
    public static $boundary_attributes = 'class="punctuation"';
    public static $number_attributes = 'class="number"';
    public static $word_attributes = 'class="word"';
    public static $error_attributes = 'class="error"';
    public static $comment_attributes = 'class="comment"';
    public static $variable_attributes = 'class="variable"';
    public static $pre_attributes = 'class="syntax-highlighted-query"';
